...
import {isValidEnumValue} from "../../lib/type-utils";
import {openNotificationWithIcon} from "../../lib/notification-utils";
        ...
        <Layout style={{minHeight: '100vh'}}>
            <Sider collapsible collapsed={collapsed} onCollapse={onCollapse}>
                <div className="logo" style={{margin: 'auto'}}>
                    <MehTwoTone style={{fontSize: '52px', padding: '8px', display: 'block', margin: 'auto'}}/>
                </div>
                <Menu
                    theme="dark"
